...
from src.models.task import Task  # noqa: F401 - Import needed for autogenerate
...
def do_run_migrations(connection: Connection) -> None:
    """
    Run migrations in a given connection.
...
async def run_async_migrations() -> None:
    ...
    Creates async engine and runs migrations in a connection.
    """
